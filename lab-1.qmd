...
The data is strongly skewed to the right. Most counties have a low density. One outlier is Cook County, IL because it is significantly larger than the typical county, located on the far right of the x axis as an isolated point.
...
A negative relationship between college education and poverty exists. Generally speaking, as the percentage of people with a collage degree increases, the percentage below poverty generally decreases. The negative trend appears consistent across states with the exception of some states showing more variability at higher education levels. One outlier is Jackson, IL with 36.6% percollege and 28.4% perbelowpoverty which is higher than other counties with similar education levels.
...
One clear outlier is Menominee, WI with 48.69% below poverty and 7.34% college educated. The population is predominantly Amerindian (3469) followed by white (416), then other (5).
...
The relationship appears the same. This is because the units have changed but not the underlying land area values. The plot has been re scaled but the underlying relationship does not change.
